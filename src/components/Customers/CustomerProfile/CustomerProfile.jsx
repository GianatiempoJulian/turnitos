...
const CustomerProfile = () => {
  ...
  async function getAllAppointments() {
    await axios
      .get(`http://127.0.0.1:8000/api/customer/1/appointments`)
      .then((response) => {
        setAppointment(response.data.appointmentsFromCustomer);
        console.log(response.data.appointmentsFromCustomer);
      })
      .catch((error) => {
  ...
  async function handleCancel(id) {
    ...
    try {
      ...
      alert("El turno no pudo ser cancelado. Intenta nuevamente.");
    }
  }
